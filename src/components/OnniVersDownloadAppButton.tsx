  ...
  return (
    ...
    >
      <button
        ...
        className="group relative isolate overflow-hidden rounded-2xl px-1 py-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/80 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
        ...
        <span className="relative flex items-center gap-3 px-6 py-3.5 sm:px-8 sm:py-4">
          <span
            aria-hidden
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-cyan-400/40 bg-cyan-500/10 shadow-[0_0_24px_hsl(175_80%_50%/0.35)] transition-transform duration-300 group-hover:scale-105 group-hover:shadow-[0_0_32px_hsl(175_80%_55%/0.5)]"
          >
            <Download className="h-5 w-5 text-cyan-100" strokeWidth={2.25} />
          </span>

          <span className="flex flex-col items-start text-left">
            <span className="flex items-center gap-1.5 font-display text-[10px] font-semibold uppercase tracking-[0.28em] text-cyan-300/90 sm:text-[11px]">
              <Sparkles className="h-3 w-3 text-violet-300" aria-hidden />
              OnniVers PC
            </span>
            <span className="bg-gradient-to-r from-cyan-50 via-white to-violet-100 bg-clip-text font-headline text-base font-semibold tracking-wide text-transparent sm:text-lg">
              Centro de descarga
            </span>
          </span>
